...
namespace memory_rc
{
  ...
  void test_basic()
  {
    ...
    // Allocate some objects and test that they are removed when decrefed to
    // zero.
    {
      auto& alloc = ThreadAlloc::get();
      auto* o = new (alloc) C;
      ...
      /* RegionRc::gc(alloc, o); */
      check(Region::debug_size(o) == 3); // nothing collected

      // Manually decref an object
      o->f1 = nullptr;
      RegionRc::decref(alloc, o1, o);

      check(Region::debug_size(o) == 2); // object collected
    }
  }
